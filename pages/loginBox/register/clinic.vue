  ...
  <view class="container">
    <form @submit="formSubmit" @reset="formReset">
      <view class="one_flr">
        ...
        <tui-list-cell :hover="false">
          <view class="tui-line-cell">
            <view class="tui-title">诊所名称</view>
            <input
              placeholder-class="phcolor"
              class="tui-input"
              name="CoopClinicName"
        ...
        <tui-list-cell :hover="false">
          <view class="tui-line-cell">
            <view class="tui-title">负责人姓名</view>
            <input
              placeholder-class="phcolor"
              class="tui-input"
              name="Principal"
      ...
      <view class="tow_flr">
        ...
        <view class="tui-line-cell">
          ...
          <iv-upload :serverUrl="serverUrl" @complete="result" @remove="remove"></iv-upload>
          <iv-upload :serverUrl="serverUrl" @complete="result" @remove="remove"></iv-upload>
           
        </view>
       
      </tui-list-cell>
       <view class="explain">说明： 上传小于2M，支持JPG、PNG、JPEG</view>
      <tui-list-cell :hover="false">
        <view class="tui-title">选择地址</view>
        <view class="s-input s-select" @tap="showPicker">
            <text class="text  wid27">{{text[0]}}</text>
            <image src="../../../static/images/login/icon_right.png" class="img30 pdr20"></image>
            <text class="text  wid27">{{text[1]}}</text>
            <image src="../../../static/images/login/icon_right.png" class="img30 pdr20"></image>
            <text class="text wid46">{{text[2]}}</text>
            <image src="../../../static/images/login/icon_down.png" class="img32 flr"></image>
          </view>
      </tui-list-cell>
           <tui-list-cell :hover="false">
        <view class="tui-line-cell">
      ...
      <view class="tui-btn-box">
        <button class="btn-primary tui-btn-submit tui-btn-green" hover-class="btn-hover"   :disabled="disabled" form-type="submit">提交注册信息</button>
      </view>
    </form>
